...
Companion skill: [`codebase-memory`](../codebase-memory/SKILL.md). Install binary: see that skill’s install block. Cursor MCP config: [`.cursor/mcp.json`](../../../.cursor/mcp.json).
