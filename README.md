...
**Instrument track:** I1 + I2 (wipe/blink/split + comparison archive) landed; next is I3–I5 — see [`docs/CONTINUATION_PLAN.md`](docs/CONTINUATION_PLAN.md) and [`docs/INSTRUMENT_GROUNDING_PLAN.md`](docs/INSTRUMENT_GROUNDING_PLAN.md).
