...
| Sim Ultra QA (CI / TestClient) | 2026-07-25 | Ubuntu · no dGPU · adapter fixtures | n/a | ✅ SW v29 | ✅ API | ✅ snapshots | ✅ Ultra classify + soft pixels + synthetic fps matrix | ✅ Neutral | ✅ unit | Automated P0 stand-in; see `docs/SIMULATED_ULTRA_QA.md` |
