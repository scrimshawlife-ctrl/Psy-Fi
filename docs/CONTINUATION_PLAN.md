...
- [x] PWA: `/gpu/` **separate route** ([`PWA_GPU_ROUTE.md`](PWA_GPU_ROUTE.md) · SW v21)
...
- [x] Root-scoped service worker (`/sw.js` · `Service-Worker-Allowed: /` · SW v21) so offline shell + `/gpu/` network-first actually run
