...
- [x] PWA: `/gpu/` **separate route** ([`PWA_GPU_ROUTE.md`](PWA_GPU_ROUTE.md) · SW v22)
...
- [x] Root-scoped service worker (`/sw.js` · `Service-Worker-Allowed: /` · SW v22) so offline shell + `/gpu/` network-first actually run
