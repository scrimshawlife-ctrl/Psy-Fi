...
| **P1** | Instrument & Spatiotemporal Grounding (I1–I5) | **planned** — non-linear controls, hold-and-compare, optional anchors, planner stage, Journey objects (`INSTRUMENT_GROUNDING_PLAN.md`) |
