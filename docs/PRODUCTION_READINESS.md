...
| **P1** | Instrument & Spatiotemporal Grounding (I1–I5) | **Blocked:** restore `index.html` from `99f9e44` (stub on main); I1 map helper only; I2 player-side done; chrome open (`CONTINUATION_PLAN.md`) |
